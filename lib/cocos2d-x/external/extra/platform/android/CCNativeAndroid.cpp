...
using namespace cocos2d;	// add by hanyi
...
{
//    CCLOG("CCNative::openURL() - not support this platform.");	commit by hanyi
	// add by hanyi start here
	JniMethodInfo methodInfo;
    if (JniHelper::getStaticMethodInfo(methodInfo, "org/cocos2dx/lib/Cocos2dxHelper", "openURL", 
        "(Ljava/lang/String;)V"))
    {
