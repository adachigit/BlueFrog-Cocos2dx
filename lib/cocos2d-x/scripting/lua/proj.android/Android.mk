...
ifndef $(QUICK_MINI_TARGET)
    ...
    LOCAL_SRC_FILES += \
						...
						../lua_extensions/xml/lua_xml.c	\
						../lua_extensions/bit/lua_bit.c	\
                        ../lua_extensions/lua_extensions.c \
                        ../lua_extensions/serialize/lua_cmsgpack.c
...
LOCAL_EXPORT_C_INCLUDES := $(LOCAL_PATH)/../lua/lua-5.1.5/src \
                           ...
                           $(LOCAL_PATH)/../cocos2d-x/scripting/lua/lua_extensions/bit	\
                           $(LOCAL_PATH)/../cocos2d-x/scripting/lua/lua_extensions/xml
...
LOCAL_CFLAGS += -Wno-psabi -DCC_LUA_ENGINE_ENABLED=1 $(ANDROID_COCOS2D_BUILD_FLAGS) -std=c++11
