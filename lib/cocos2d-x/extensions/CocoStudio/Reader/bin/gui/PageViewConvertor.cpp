...
namespace gui
{
	void PageViewConvertor::writeProperties(const rapidjson::Value& options, uint32_t node, BinWriter& writer)
	{
	...
	void PageViewConvertor::readProperties(UIPageViewEx* pWidget, NodeElement* optionsNode, BinReader& reader)
	{
